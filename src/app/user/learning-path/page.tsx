  ...
  const handleCheckIn = async (scheduleId: string) => {
    try {
      ...
      if (response.success) {
        ...
        if (userId) {
          const updatedResponse = await scheduleService.getUserSchedules(
            userId
          );
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <Button asChild className="flex items-center gap-2">
            <Link href="/user/learning-path/edit">Edit Schedule</Link>
          </Button>
        </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            {error && !isUsingMockData && (
              <div className="text-destructive bg-destructive/10 p-3 rounded-lg border border-destructive/20 mb-4">
        ...
        {checkInError && (
          <div className="fixed top-4 right-4 z-50 max-w-sm">
            <div className="bg-card/95 backdrop-blur-sm rounded-lg p-4 shadow-lg border border-destructive/20">
        ...
        <div className="min-w-[800px]">
          ...
          <div className="grid grid-cols-7 border-b">
            {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
              <div
                key={day}
                className="p-3 bg-gray-50 border-r last:border-r-0 text-center font-medium text-gray-600"
              >
                {day}
              </div>
            ))}
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      {daySchedules.map((schedule: ScheduleItem) => {
                        ...
                        console.log(
                          `[Schedule] ${schedule.title} - isCheckin: ${schedule.isCheckin} -> ${isCheckedIn}`
                        );
