...
import { StudentBanner, FAQ, Guarantee } from "@/components/subscription/StaticSubscriptionContent"
import { subscriptionPlans, faqData, BookIcon, StarIcon, CrownIcon } from "@/components/subscription/SubscriptionCards"
    ...
    <main className="flex-1 p-6 md:p-10 w-full">
      <section className="mx-auto max-w-6xl">
        <header className="text-center space-y-2">
          <h1 className="text-2xl md:text-3xl font-bold">Gói Đăng Ký StudeeHub</h1>
        ...
        <Suspense fallback={<div>Loading pricing cards...</div>}>
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            ...
            <PricingCard
              ...
              onSelect={() => setSelectedPlan(subscriptionPlans.studentPro.id)}
              ...
              price={billingCycle === "monthly" ? subscriptionPlans.studentPro.monthlyPrice : subscriptionPlans.studentPro.yearlyPrice}
            ...
            <PricingCard
              ...
              onSelect={() => setSelectedPlan(subscriptionPlans.premiumPlus.id)}
              icon={<CrownIcon />}
              ...
              price={billingCycle === "monthly" ? subscriptionPlans.premiumPlus.monthlyPrice : subscriptionPlans.premiumPlus.yearlyPrice}
              priceSuffix={billingCycle === "monthly" ? "/tháng" : "/năm"}
      ...
      <div className="bg-white rounded-2xl p-6 h-full flex flex-col">
        ...
        <div className="flex justify-center mb-4">
          <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
            isFreemium ? "bg-gray-600" :
            isStudentPro ? "bg-purple-600" :
            isPremiumPlus ? "bg-orange-500" : "bg-gray-600"
          }`}>
            ...
            <div>
              {oldPrice && (
                <div className="flex items-center justify-center gap-2 mb-1">
                  <span className="text-sm text-gray-400 line-through">{oldPrice} VND</span>
                  {discount && (
              ...
              <div className="text-4xl font-bold text-gray-800">
                {price} <span className="text-lg font-normal">VND{priceSuffix}</span>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="flex-1 mb-6">
          <h4 className="text-sm font-semibold text-gray-800 mb-4">Tính năng bao gồm:</h4>
              ...
              <li key={idx} className="flex items-start gap-3">
                <div className={`flex-shrink-0 w-5 h-5 rounded-full flex items-center justify-center ${
                  ...
                  {feature.included ? (
                    ...
                    <span className="w-3 h-3 text-gray-400 text-xs font-bold">×</span>
                  )}
                </div>
